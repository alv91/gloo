...
func initGlooClients(ctx context.Context) (v1.UpstreamClient, v1.ProxyClient) {
	...
	upstreamClient, err := v1.NewUpstreamClient(context.Background(), &factory.KubeResourceClientFactory{
		Crd:             v1.UpstreamCrd,
		Cfg:             restConfig,
		SharedCache:     cache,
	...
	proxyClient, err := v1.NewProxyClient(context.Background(), &factory.KubeResourceClientFactory{
		Crd:             v1.ProxyCrd,
		Cfg:             restConfig,
		SharedCache:     cache,
		SkipCrdCreation: true,
